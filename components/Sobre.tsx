...
/**
 * COMO ADICIONAR FOTO DA EQUIPE:
 * 1. Coloque o arquivo em /public/fotos/   ex: /public/fotos/equipe-campo.jpg
 * 2. Preencha o campo  src  abaixo.
 */
const fotoEquipe = { src: '', caption: 'Fotografia — Equipe técnica em campo' }
      ...
      <div className="wrap">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '5fr 4fr', gap: 0 }}>
          ...
          <div className="reveal" style={{ paddingRight: 56 }}>
            ...
            <FotoSlot
              src={fotoEquipe.src || undefined}
              caption={fotoEquipe.caption}
              style={{ minHeight: 280, marginTop: 36 }}
            />
          </div>
