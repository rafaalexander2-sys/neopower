 ...
 * 1. Coloque os arquivos em /public/fotos/   ex: /public/fotos/casos-usina.jpg
 * 2. Preencha o campo  src  abaixo.
 */
const fotos = {
  principal: { src: '', caption: 'Fotografia autoral — Vista geral da usina de 93 kWp' },
  detalhe:   { src: '', caption: 'Detalhe — Infraestrutura de Média Tensão' },
}
    ...
    <section id="casos" style={{ background: 'var(--bg-surface)', padding: '100px 0' }}>
      <div className="wrap">
        ...
        <div className="reveal" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 16 }}>
          <FotoSlot src={fotos.principal.src || undefined} caption={fotos.principal.caption} style={{ minHeight: 240 }} />
          <FotoSlot src={fotos.detalhe.src || undefined}   caption={fotos.detalhe.caption}   style={{ minHeight: 240 }} />
        </div>
      </div>
